...
const preload = fast ? await Bun.build({ entrypoints: [resolve(import.meta.dir, '../../src/incremental-preload.ts')], target: 'browser', format: 'iife', define: { __PREVIEW_COMPLETE__: JSON.stringify(writeCoverage.unsupported === 0) } }) : null

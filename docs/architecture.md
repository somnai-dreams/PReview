...
The [large-transfer investigation](large-transfers.md) measures cold-transfer memory and phase costs, records limited prototype gains, and proposes consolidating capture, reconciliation and indexing around one correspondence owner. That design remains unimplemented; the investigation does not establish a fix for large application workloads.
